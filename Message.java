...
public class Message {
    ...
    private static void saveMessageToJson(List<Message> messages, String messagejason) {
    ...
    public static void main(String[] args) {
        ...
        messages.add(new Message ("+27123456789", "Hello, this is my first message", 1));
        messages.add(new Message("+27987654321", "This is my second message",2));
        
        saveMessageToJson(messages, "message.jason");
    }
    ...
    BooleanSupplier checkMessageID() {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }  
